...
\AddToShipoutPicture*
  {\put(465,767){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.py}{\raisebox{-0.198 em}{\includegraphics[width=0.35cm,height=0.35cm]{stringdiagrampicture.png}}\texttt{ Braid group}}
  }}

\AddToShipoutPicture*
  {\put(465,752){\href{https://ncatlab.org/nlab/show/Whitehead+theorem}{\raisebox{-0.168 em}{\includegraphics[width=0.33cm,height=0.33cm]{nlablogo.png}}\texttt{ nLab}}\\
  }}

\AddToShipoutPicture*
  {\put(465,737){\href{https://en.wikipedia.org/wiki/Whitehead\_theorem}{\texttt{\raisebox{-0.158 em}{\includegraphics[width=0.38cm,height=0.30cm]{wikipedialogo.png}} Wikipedia}}\\
  }}
...
\AddToShipoutPicture*
  {\put(375,767){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.lean}{\texttt{\raisebox{-0.1 em}{\includegraphics[width=0.30cm,height=0.30cm]{leanlogo.png}} Lean file}}}}

\AddToShipoutPicture*
  {\put(375,752){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.agda}{\texttt{\raisebox{-0.09 em}{\includegraphics[width=0.33cm,height=0.31cm]{agdalogo.png}} Agda file}}}}

\AddToShipoutPicture*
  {\put(375,737){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.v}{\texttt{\raisebox{-0.17 em}{\includegraphics[width=0.31cm,height=0.34cm]{coqlogo.png}} Coq file}}}}

  \AddToShipoutPicture*
  {\put(375,722){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.thy}{\texttt{\raisebox{-0.2 em}{\includegraphics[width=0.34cm,height=0.35cm]{isabellelogo.png}} Isabelle file}}}}
...
\AddToShipoutPicture*
  {\put(185,737){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.tex}{\texttt{Latex file}}
  }}

  \AddToShipoutPicture*
  {\put(185,722){\href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.pdf}{\texttt{PDF file}}
  }}
...
\ \\
\ \\
\scalebox{2.8}{\texttt{The Whitehead Theorem}}\
\ \\
\ \\
\end{center}
\end{tcolorbox}
...
%LEAN: 
\begin{center}
\begin{tcolorbox}[width=5.8in,colback={white}]
\begin{center}
\scalebox{0.62}{∀(C:Ho(DirCWCat)),∀(D:Ho(DirCWCat)),∀(F:Ho(DirCWCat).Hom C D),∀(G:Ho(DirCWCat).Hom C D),(∀(n:Nat),(Π⃗ₙ F = Π⃗ₙ G)) → F = G}\\
\ \\
\scalebox{0.62}{∀(X:Ho(CWCat)),∀(Y:Ho(CWCat)),∀(f:Ho(CWCat).Hom X Y),∀(g:Ho(CWCat).Hom X Y),(∀(n:Nat),(Πₙ f = Πₙ g)) → f = g}\\
\ \\
\scalebox{0.62}{∀(C:Ho(DirCWCat₋₁)),∀(D:Ho(DirCWCat₋₁)),∀(F:Ho(DirCWCat₋₁).Hom C D),∀(G:Ho(DirCWCat₋₁).Hom C D),(∀(n:Nat),(π⃗ₙ F = π⃗ₙ G)) → F = G}\\
\ \\
\scalebox{0.62}{∀(X:Ho(CWCat₋₁)),∀(Y:Ho(CWCat₋₁)),∀(f:Ho(CWCat₋₁).Hom X Y),∀(g:Ho(CWCat₋₁).Hom X Y),(∀(n:Nat),(πₙ f = πₙ g)) → f = g}\\
...
\begin{tcolorbox}[width=5.8in,colback={white}]
\begin{center}
\scalebox{0.5}{∀(C:D(∞-Cat)),∀(D:D(∞-Cat)),∀(F:D(∞-Cat).Hom C D),∀(G:D(∞-Cat).Hom C D),(∀(n:Nat),(Π⃗ₙ F = Π⃗ₙ G)) → F = G}\\
\ \\
\scalebox{0.5}{∀(X:D(∞-Grpd)),∀(Y:D(∞-Grpd)),∀(f:D(∞-Grpd).Hom X Y),∀(g:D(∞-Grpd).Hom X Y),(∀(n:Nat),(Πₙ f = Πₙ g)) → f = g}\\
\ \\
\scalebox{0.5}{∀(C:D(∞-Cat₋₁)),∀(D:D(∞-Cat₋₁)),∀(F:D(∞-Cat₋₁).Hom C D),∀(G:D(∞-Cat₋₁).Hom C D),(∀(n:Nat),(π⃗ₙ F = π⃗ₙ G)) → F = G}\\
\ \\
\scalebox{0.5}{∀(X:D(∞-Grpd₋₁)),∀(Y:D(∞-Grpd₋₁)),∀(f:D(∞-Grpd₋₁).Hom X Y),∀(g:D(∞-Grpd₋₁).Hom X Y),(∀(n:Nat),(πₙ f = πₙ g)) → f = g}\\
...
\ \\
\begin{center}
\texttt{Plans to prove the Whitehead theorem in Lean 4 using Mathlib 4}
\end{center}
\ \\
\ \\
...
We wish to acknowledge the collaborative efforts of E. Dean Young and Jiazhen Xia. Together the authors are pursuing these plans as a long term project.\\
...
{\bf The main goal of this repository is to prove the Whitehead theorem in Lean 4 using Mathlib 4's homotopy groups}. Three other subsequent goals are to state and prove three variations of the Whitehead theorem:\\
...
\item D(Πₙ) : Functor D(∞-Grpd) (Map Set)
\item D(Π⃗ₙ) : Functor D(∞-Cat) (Map Set)
\end{enumerate}
...
Here are some s to Lean 4 and Mathlib 4:

\begin{enumerate}
\item The tutorial \href{https://leanprover.github.io/theorem_proving_in_lean4/}{here} gives an  to using the dependent type theory in Lean.
\item 
\end{enumerate}
...
In this section, we construct the homotopy category of Based ∞-groupoids D(∞-Grpd₋₁) as the category of (CW) complexes with homotopy classes of maps. A CW-complex, which we here refer to as a complex.\\
...
The derived category of an overcategory of Based ∞-groupoids...\\



\section{Σ : ∞-Grpd₋₁ ⇄ ∞-Grpd₋₁ : Ω}

The loop space functor $\texttt{Ω : Functor ∞-Grpd₋₁ ∞-Grpd₋₁}$ is right adjoint to the (Based) suspension functor $\texttt{Σ : Functor ∞-Grpd₋₁ ∞-Grpd₋₁}$.



\section{σ f : ∞-Grpd₋₁/B ⇄ ∞-Grpd₋₁/E : ω f, f : ∞-Grpd₋₁.Hom E B}

The homotopy fiber

\iffalse
Is this homotopy pullback with S₀?
\fi

Based homotopy pushout

\iffalse
Is this homotopy pushout with S₀?
\fi

\section{πₙ : Functor ∞-Grpd₋₁ Set}

The homotopy groups can be first understood as functors into $\texttt{Set}$, only later adding in the fact that $\texttt{πₙ}$ factors through $\texttt{InternalGroup • ⋯ • InternalGroup Set ≃ InternalAbelianGroup Set ≃ AbelianGroup}$ for $\texttt{n ≥ 2}$, and $\texttt{InternalGroup Set ≃ Group}$ for $\texttt{n = 1}$.\\
...
\begin{center}
\texttt{∀(E:D(∞-Grpd₋₁)),∀(B:D(∞-Grpd₋₁)),∀(f:D(∞-Grpd₋₁).Hom E B),∀(G:D(∞-Grpd₋₁).Hom E B),(∀(n:Nat),(πₙ F = πₙ G)) ⭢ F = G}
\end{center}
...
\begin{theorem}
$\texttt{B(2,1) × B(2,∞) ≅ B(2,∞)}$, where B is the unit ball in l₂ under the 2-norm.
\end{theorem}

\begin{proof}
Define a function f : B(2,1) × B(2,∞) $\rightarrow$ B(2,∞) sending (t,x) to ...
\end{proof}
...
\begin{proof}
Define a function $\texttt{f : I × B(∞,∞) ⭢ B(∞,∞)}$ sending $\texttt{f(x,(aₙ))}$ to $\texttt{f(bₙ)}$ where $\texttt{fb₀ = x}$ and $\texttt{fbₙ = a}$${}_{n-1}$. $f$ is continuous. 

Define a function $\texttt{g₁ : B(∞,∞) ⭢ I}$ sending $\texttt{(aₙ)}$ to $\texttt{a₀}$.\\

Define a function $\texttt{g₂ : B(∞,∞) ⭢ I}$ sending $\texttt{(aₙ)}$ to $\texttt{(bₙ)}$ where $\texttt{bₙ = a}$${}_{n+1}$.\\

Define a function $\texttt{g : B(∞,∞) ⭢ I × B(∞,∞)}$.\\
\iffalse
$\texttt{g • f = 1}{}_{I × B(∞,∞)}$ and $\texttt{f • g = 1}{}_{B(∞,∞)}$.
\fi
\end{proof}
...
\iffalse
\begin{theorem}
There is a continuous function $\texttt{proj}_{\texttt{n}} : \texttt{Dⁿ × I} \rightarrow \texttt{Jₙ}$ such that .
\end{theorem}

After this, we show that $\texttt{projₙ • jₙ} = 1_\texttt{Jₙ}$.\\
...
{\bf Change of Base} Change of base demonstrates that πₙ(X,x) is isomorphic to πₙ(X,y) for a connected CW-complex X and two different points x and y in X. This change depends on a path between them.\\

Given a path $\texttt{jj}$

\iffalse
the use of a jar factors through the use of a line
\fi


The construction proceeds by defining a sphere 
...
\iffalse
\begin{center}
\includegraphics[width=8.75cm,height=5cm]{basechange.png}
\end{center}
\fi
...
\iffalse
\begin{center}
\includegraphics[scale=0.35]{pictureframe.png}
\end{center}
\fi
...
\iffalse
- smooth jar filling with the unit ball in l₂
\fi
...
\begin{lemma}
Given Based complexes $\texttt{X, Y : ∞-Grpd₋₁}$ and continuous maps $\texttt{f, g : ∞-Grpd₋₁.Hom X (Ω.obj Y)}$, and a continuous function $\texttt{∞-Grpd₋₁.Hom I pushout d₀ d₁}$ such that $\texttt{}$, ...
\end{lemma}
...
Note: the `little lines' operad and its algebras arise in the study of how .\\

\begin{theorem}[HEP] Given a Based complex $\texttt{X}$ and a space $\texttt{Y}$ with $\texttt{π₀.obj X ≅ *}$ and a continuous maps $\texttt{f : ∞-Grpd₋₁.Hom X (Ω.obj Y)}$ which is weak equivalent to $0$, there is a homotopy $\texttt{f ≃ *}$ between $\texttt{f}$ and the constant function $\texttt{* : ∞-Grpd₋₁ X Y}$.
\end{theorem}

\begin{proof}
For each $\texttt{n : Nat}$, let $\texttt{Xₙ}$ be the nth space in the complex $\texttt{X}$, and let $\texttt{αₙ : ∞-Grpd₋₁.Hom (Aₙ × Sⁿ) Xₙ}$ be the attaching map. Let $\texttt{fₙ}$ be the precomposition of $\texttt{f}$ with the map $\texttt{∞-Grpd₋₁.Hom Xₙ X}$. We construct a homotopy $\texttt{f ≃ *}$ inductively. 
\end{proof}
...
\begin{theorem}[HEP] Given Based complexes $\texttt{X}$ and $\texttt{Y}$ with $\texttt{π₀.obj X ≅ *}$ and continuous maps φ : ???.Hom Sⁿ X, f : pushout ∂Dⁿ⁺¹ α ⭢ Y, g : pushout ∂Dⁿ⁺¹ α ⭢ Y, H : homotopy (f • ?, g • ?), then f and g are homotopic.  
\end{theorem}
...
Here we show the Whitehead theorem using the homotopy extension property and replacement (REP).
...
In this section I cover the category of maps $\texttt{Map C}$ in a category $\texttt{C}$. After this I inductively form $\texttt{□ⁿ⁺¹ C}$ as $\texttt{Map (□ⁿ C)}$ and $\texttt{□ⁱⁿᶠ C}$ as the colimit of $\texttt{□ⁿ C}$. The category $\texttt{□ C}$ formed in this way has the property that $\texttt{Map (□ C) ≅ □ C}$.\\
...
\section{Chapter 11: The Category of Maps of ∞-Groupoids}
...
\subsection{Ω : ∞-Grpd₀ ⇄ ∞-Grpd₀ : Σ}

\begin{enumerate}
\item The Based suspension functor
\end{enumerate}


\subsection{ω f : ∞-Grpd/D₀ ⇄ ∞-Grpd/C₀ : σ f}

\begin{enumerate}
\item The homotopy fiber
\item Based homotopy pushout
\end{enumerate}


\subsection{πₙ : ∞-Grpd₀ ⇄ Set}
...
\section{Chapter 2: The Whitehead Theorem}
...
\section{Chapter 3: The Category of Maps}
...
In this chapter, we discuss internal categories and internal presheaves . We may keep in mind that internal categories and internal presheaves can be formed in any category with pullbacks, even though we focus on the case of pullback systems because of our interest in Whitehead theorem (a).\\
...
%LEAN: definition of an internal groupoid 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}
...
The internal functor structure combines with the internal category structure to give a category of internal categories .\\
...
%LEAN: definition of an internal functor 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- definition of an internal functor 
...
%LEAN: definition of the identity internal functor 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- definition of the identity internal functor 
...
%LEAN: definition of the composition of internal functors 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- definition of the composition of internal functors 
...
%LEAN: proving the first identity law for internal categories 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- proving the the first identity law for internal categories 
...
%LEAN: proving the second identity law for internal categories  
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- proving the second identity law for internal categories 
...
%LEAN: proving the associativity law for internal categories 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- proving the associativity law for internal categories 
...
%LEAN: defining the category of internal categories 
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}
...
structure pullback {C : Category₇} {X₁ : C.Obj} {X₂ : C.Obj} {X : C.Obj} (f₁ : C.Hom X₁ X) (f₂ : C.Hom X₂ X) where
  Obj : C.Obj
  Pr₁ : C.Hom Obj X₁
  Pr₂ : C.Hom Obj X₂
  Eqn : (C.Cmp Obj X₁ X Pr₁ f₁) = (C.Cmp Obj X₂ X Pr₂ f₂)
  Str : ∀(Y : C.Obj),∀(g₁ : C.Hom Y X₁),∀(g₂ : C.Hom Y X₂),∀(_ : C.Cmp Y X₁ X g₁ f₁ = C.Cmp Y X₂ X g₂ f₂),∃(g : C.Hom Y Obj),((C.Cmp Y Obj X₁ g Pr₁ = g₁) ∧ (C.Cmp Y Obj X₂ g Pr₂ = g₂))
  --   Str : ∀(Y : C.Obj),∀(g₁ : C.Hom Y X₁),∀(g₂ : C.Hom Y X₂),∀(_ : C.Cmp Y X₁ X g₁ f₁ = C.Cmp Y X₂ X g₂ f₂),∃!(g : C.Hom Y Obj),((C.Cmp Y Obj X₁ g Pr₁ = g₁) ∧ (C.Cmp Y Obj X₂ g Pr₂ = g₂))
...
%LEAN: definition of an internal category
\begin{center}
\begin{tcolorbox}[width=5in,colback={white},title={\begin{center}\texttt{Lean \thelcounter} \addtocounter{lcounter}{1}  \end{center}},colbacktitle=Blue,coltitle=black]
\begin{minted}[breaklines, escapeinside=||]{lean}

-- definition of an internal category
structure InternalCategory (C : Category₇) where
  Obj : C.Obj
  Mor : C.Obj
  Cod : C.Hom Mor Obj
  Dom : C.Hom Mor Obj
