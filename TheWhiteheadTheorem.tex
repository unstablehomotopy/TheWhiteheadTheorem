...
\AddToShipoutPicture*
  {\put(470,767){
    \href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.py}{\texttt{.py file}}
  }}

\AddToShipoutPicture*
  {\put(470,752){
    \href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.tex}{\texttt{.tex file}}\\
...
\AddToShipoutPicture*
  {\put(470,737){
    ...
    \href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.pdf}{\texttt{.pdf file}}\\

  }}

  \AddToShipoutPicture*
  {\put(470,722){
    \href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/TheWhiteheadTheorem.lean}{\texttt{.lean file}}

  }}

\AddToShipoutPicture*
  {\put(490,767){
    \href{https://github.com/unstablehomotopy/TheWhiteheadTheorem/blob/main/StringDiagramGenerator.py}{\texttt{.py file}}
  }}
