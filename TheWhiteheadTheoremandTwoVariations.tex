...
\iffalse
Even though univalence is just one line, elegant and convenient, it isn't the only approach to computerized homotopy or categories. Another approach, here the one taken in Mathlib 4, instead makes use of replacement for dependent types, facilitated by ```HEq''' and ```cast'''.\\
