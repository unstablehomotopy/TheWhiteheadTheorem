...
\begin{center}
\ \\
\scalebox{3}{\texttt{The Whitehead Theorem and Two Variations}}\\
\ \\
\end{center}
\end{tcolorbox}
\end{center}
...
\hline \hline
 $\texttt{InternalGroup Γ}$   & The category of internal groups in Γ  \\
 \hline
 $\texttt{InternalGroupAction Γ G₀}$ & The category of internal G₀-actions in Γ   \\
 \hline
  $\texttt{OperadicGroup Γ}$  & The category of operadic groups  \\
 \hline
 $\texttt{OperadicGroupAction Γ}$  & The category of operadic group actions  \\
 \hline
...
The Whitehead theorem for pairs of ∞-groupoids & ... \\
\hline \hline
\multicolumn{2}{||c||}{\texttt{Chapter 12: Internal Categories and Internal Sheaves}} \\
\hline \hline
 $\texttt{InternalCategory Γ C}$   & The category of internal categories \\
 \hline
 $\texttt{InternalPresheaf Γ C X}$  & The category of internal presheaves \\
 \hline
  $\texttt{OperadicCategory Γ}$  & The category of operadic categories  \\
 \hline
 $\texttt{OperadicPresheaf Γ}$   & The category of operadic presheaves  \\
  \hline
...
{\bf The main goal of this repository is to prove the Whitehead theorem and two variations of it}. It is important that initial pull requests stemming from our work remain basic and accessible; we hope to make progress which is gradual and incremental.\\
...
-- def InternalGroup (Γ : pulback_system) : 𝐂𝐚𝐭.Obj := sorry
...
-- notation "Grp_(" Γ  ")" => InternalGroup Γ
...
\section{Operadic Groups}



\section{Operadic Group Actions}



\section{The O and P Functors}
...
\chapter{Chapter 6: The Whitehead Theorem for ∞-Groupoids}
...
\chapter{Chapter 7: The Category of Pairs of ∞-Groupoids}




\chapter{Chapter 8: Internal and Operadic Groupoids and their Actions}
...
\chapter{Chapter 10: The Whitehead Theorem for ∞-Categories}
...
\chapter{Chapter 11: The Category of Pairs of ∞-Categories}

...\\


\chapter{Chapter 12: Internal and Operadic Categories and their Presheaves}
